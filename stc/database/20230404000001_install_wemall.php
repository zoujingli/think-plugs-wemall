...
class InstallWemall extends Migrator
{
    ...
    private function _create_plugin_wemall_goods()
    {
        ...
        $this->table($table, [
            ...
            ->addColumn('rebate_type', 'integer', ['limit' => 1, 'default' => 1, 'null' => true, 'comment' => '参与返佣(0无需返佣,1需要返佣)'])
    ...
    private function _create_plugin_wemall_user_rebate()
    {
        ...
        $this->table($table, [
            ...
            ->addIndex('order_no', ['name' => 'idx_plugin_wemall_user_rebate_order_no'])
            ->addIndex('order_unid', ['name' => 'idx_plugin_wemall_user_rebate_order_unid'])
